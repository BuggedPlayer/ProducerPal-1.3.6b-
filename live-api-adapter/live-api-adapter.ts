...
import { loadItem } from "#src/tools/browser/load-item.ts";
import { readBrowser } from "#src/tools/browser/read-browser.ts";
...
const tools: Record<string, (args: unknown) => unknown> = {
  ...
  "ppal-read-browser": (args) => readBrowser(args as any),
  "ppal-load-item": (args) => loadItem(args as any),
};
